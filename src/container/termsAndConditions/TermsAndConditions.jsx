    ...
    <div className="policy-container settings-page">
      ...
      <div className="settings-content">
        <div className="terms-text">
          ...
          <p>
            ● Understand that Pocket For Pi is built for use exclusively within the{" "}
    ...
    <div className="app-container settings-page">
      ...
      <div className="settings-content">
        <div className="terms-text">
          ...
          <h5>5. डेटा उपयोग</h5>
          <p>
            Pocket For Pi सीमित व्यक्तिगत और लेन-देन डेटा एकत्र करता है, जैसा कि
          ...
          <p>
            Pocket For Pi "जैसा है" और "उपलब्ध होने पर" आधार पर प्रदान किया जाता है।
    ...
    <div className="app-container settings-page" dir="rtl">
      ...
      <div className="settings-content">
        <div className="terms-text">
          ...
          <p>Pocket For Pi يقدم الخدمات التالية:</p>
          ...
          <p>● المعاملات الأساسية داخل محافظ Pocket For Pi مجانية حتى حد يومي.</p>
          ...
          <p>
            Pocket For Pi يجمع بيانات محدودة وفقًا لسياسة الخصوصية. نحن{" "}
          ...
          <p>
            Pocket For Pi مقدم "كما هو" و"حسب التوفر". نحن <b>غير مسؤولين</b> عن:
          </p>
